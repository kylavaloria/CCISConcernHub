                ...
                <div className="w-full p-4 max-w-2xl mx-10">
                    ...
                    <form className="space-y-4">
                        <div className="form-group">
                            ...
                            <select id="issue-type" name="issue-type" required className="border border-blue-300 rounded p-2 w-full">
                        ...
                        <div className="form-group">
                            ...
                            <select id="category" name="category" required className="border border-blue-300 rounded p-2 w-full">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" id="subject" name="subject" required className="border border-blue-300 rounded p-2 w-full" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="description" className="block mb-1">Description *</label>
                            <textarea id="description" name="description" required className="border border-blue-300 rounded p-2 w-full h-24" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="attachment" className="block mb-1">Attachment</label>
                            <input type="file" id="attachment" name="attachment" className="border border-blue-300 rounded p-2 w-full" />
                        </div>
